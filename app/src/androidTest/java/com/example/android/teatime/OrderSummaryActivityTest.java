...
public class OrderSummaryActivityTest {
    ...
    private static final String emailMsg = "I just ordered a delicious tea from TeaTime. " +
    ...
    @Rule public IntentsTestRule<OrderSummaryActivity> mActivityRule =
    ...
    public void clickSendEmailButton_SendsEmail() {
        ...
        intended(allOf(
                hasAction(Intent.ACTION_SENDTO), hasExtra(Intent.EXTRA_TEXT, emailMsg)));
    }
}